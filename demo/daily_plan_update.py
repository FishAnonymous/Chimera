...
def update_daily_schedule_with_gpt(previous_schedule, member_profile, incom_email_data, reply_email_data, current_time, id_role_map):
...
def update_daily_schedule_with_gpt_attack(previous_schedule, member_profile, incom_email_data, reply_email_data, current_time, id_role_map, attack_info):
...
def update_daily_schedule(previous_schedule, member_profile, incom_email_data, reply_email_data, current_time, id_role_map):

    for attempt in range(config.max_attempt):
        
        output_schedule = update_daily_schedule_with_gpt(previous_schedule, member_profile, incom_email_data, reply_email_data, current_time, id_role_map)
...
def update_daily_schedule_attack(previous_schedule, member_profile, incom_email_data, reply_email_data, current_time, id_role_map, attacker, attack_info):

    for attempt in range(config.max_attempt):

        if attacker:
            output_schedule = update_daily_schedule_with_gpt_attack(previous_schedule, member_profile, incom_email_data, reply_email_data, current_time, id_role_map, attack_info)
        else:
            output_schedule = update_daily_schedule_with_gpt(previous_schedule, member_profile, incom_email_data, reply_email_data, current_time, id_role_map)
