...
class Member:
    ...
    def update_schedule(self, incom_email_data, reply_email_data, current_time):
        ...
        updated_schedule = update_daily_schedule_attack(self.schedule, self.member_profile, incom_email_data, reply_email_data, current_time, self.id_role_map, self.attacker, attack_info)
        ...
        if "break" in activity:
            ...
            if "@" in activity:
                ...
                process = Process(
                    ...
                    args=(self.week, self.date, activity, self.id, self.logging_dir, self.execution_task_id, self.temp_dir)
                    )
                process.start()
                # process.join()
    ...
    def move_to_next_task(self, current_time):
        ...
        if self.schedule_index < len(self.schedule):
            ...
            if self.login_state:
                ...
                self.can_logout = False
            self.no_more_task = True
            # TODO: summarize the work for one day and save for future usage
...
if __name__ == "__main__":
    ...
    parser.add_argument("--attackid", type=str, required=True, help="Attack id, e.g., gen_attack_1")
