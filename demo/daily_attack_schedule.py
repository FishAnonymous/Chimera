...
def attack_daily_schedule_with_gpt(initial_schedule, member_profile, attack_info, id_role_map):
    ...
    system_prompt = f"""Your name is {member_profile['name']}. 
                            ...
                            **I will provide you with your initial time schedule for today to work as the regular comployee, while you should update the schedule to include your attack behaviors in your schedule.**
