...
def select_attack_date(attacker, attack_id, id_role_map):
    ...
    schedule_path = os.path.join(config.base_dir, "experiment_output", f"gemini_{company_id}", "init_schedule")
